...
sjr <- readr::read_csv2("scimagojr2024.csv") |> 
  select(Title, Issn, SJR, `SJR Best Quartile`) |> 
  tidyr::separate(Issn, into = c("Issn1", "Issn2"), sep = ", ", fill = "right") |> 
  filter(!is.na(Issn1) | !is.na(Issn2)) |> 
  mutate(Issn = ifelse(!is.na(Issn1), Issn1, Issn2)) |> 
